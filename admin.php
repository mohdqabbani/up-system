...
if (isset($_POST['add'])) {
    ...
    $adminClass->insertAdmin($adminClass->admin_name, $adminClass->admin_username, $adminClass->admin_password, $adminClass->admin_status);
...
if (isset($_POST['delete'])) {
    $adminClass = new admin_method();
    $adminClass->admin_name = filter_input(INPUT_POST, 'name', FILTER_SANITIZE_STRING);
    $adminClass->deleteAdmin($adminClass->admin_name);
    header("Location:admin.php");
    exit();
}
if (isset($_POST['selectAll'])) {
    $adminClass = new admin_method();
    $adminClass->selectAll();
}
...
if(isset($_POST['selectById'])){
    ...
    $adminClass->selectById($adminClass->admin_id);
}
?>
<html>
    <head>
